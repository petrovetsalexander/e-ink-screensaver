...
погода, новости, заметки-стикеры и книга, которую вы читаете. Изображение
...
- **Обновление панели одним проходом** вместо мигания чёрным и белым —
  быстрее и дешевле по батарее.
...
настройках приложения и что выдано разрешение на уведомления. После
переустановки приложения сервис нужно перезапустить — выключите и включите
скринсейвер.
